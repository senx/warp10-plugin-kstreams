...
public class KSPARTITION extends NamedWarpScriptFunction implements WarpScriptStackFunction {

  public KSPARTITION(String name) {
    super(name);
  }
  ...
  public Object apply(WarpScriptStack stack) throws WarpScriptException {
    ...
    stack.push((long) context.partition());
