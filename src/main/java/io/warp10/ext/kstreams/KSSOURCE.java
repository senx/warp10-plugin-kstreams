...
public class KSSOURCE extends NamedWarpScriptFunction implements WarpScriptStackFunction {

  public KSSOURCE(String name) {
    super(name);
  }
  ...
  public Object apply(WarpScriptStack stack) throws WarpScriptException {
    ...
    KStreamsUtils.addSource(topology, params);
